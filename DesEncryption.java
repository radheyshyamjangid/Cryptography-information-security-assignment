...
public class DesEncryption {
    ...
    String[] RoundKeyArray = new String[4];
    ...
    String RoundKey = "";
    String originalKey = "";
    int[] NumLeftShifts = {1, 1, 2, 2};//, 2, 2, 2, 2, 1, 2, 2, 2};//, 2, 2, 2, 1};//,2,2,2,2,2,2,1,2};
    ...
    public void Encryption() {
        ...
        try {
            ...
            originalKey = "1334577799ACFDFF2";//userInput.nextLine();
            ...
            originalKey = "radheyshyamjangid";//userInput.nextLine();
            ...
            if (plainTextLength < 64) {
                ...
                for(int id = loop, wordCount = 1; id >0; id--, wordCount++) {
                    ...
                    for (String k : RoundKeyArray) {
                        pw.println();
                        pw.println("Performanace of 64-bit " + wordCount+ " for round no.: "+counter+".");
            ...
            for(int id = loop, wordCount = 1; id >0; id--,wordCount++) {
                ...
                for (int p = 3; p >= 0; p--) {
                    ...
                    pw.println("Performanace of 64-bit "+wordCount+" for round no.: "+counter+".");
                    pw.println("___________________________________________________________________________________");
    ...
    public static void main(String[] args) {
        ...
        //final long startTime = System.nanoTime();
            ...
            long duration=0;
            DesEncryption myDes = new DesEncryption();
            for(int i=0;i<500;i++){
        ...
        System.out.println("The elapsed time: " + duration+"sec");  
